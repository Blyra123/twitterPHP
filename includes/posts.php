						...
						<div class="row">
							...
							<div class="tweet__wrapper">
								<header class="tweet__header">
									...
									<?php if (($_SESSION['user']['id']) && ($post['user_id'] == $_SESSION['user']['id'])) { ?>
						...
						<footer>
							...
							if (logged_in()) { 
								if (is_post_liked($post['id'])) { ?>
									<a href="<?php echo get_url('includes/delete_like.php?id='. $post['id']); ?>" class = "tweet__like 
										tweet__like active"><?php echo $likes_count; ?></a>
								<?php } else { ?>
